...
class URLS:
    ...
    # Transfermarkt — squad values and injury news
...
class SEASONS:
    ...
    """
    # Full training history available
    ALL_SEASONS = [
...
class FEATURES:
    ...
    # Match importance score thresholds (league position)
...
class ELO:
    ...
    # Typical football home advantage is ~100 ELO points
    HOME_ADVANTAGE      = 100
...
if __name__ == "__main__":
    ...
    print(f"  Leagues      : {', '.join(ALL_LEAGUE_CODES)}")
